    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="switcher-canvas" aria-labelledby="offcanvasRightLabel">
        ...
        <div class="offcanvas-body">
            ...
            <div class="tab-content" id="nav-tabContent">
                ...
                <div class="d-flex canvas-footer justify-content-between align-items-center">
                    <a class="btn btn-primary" target="_blank" href="https://themeforest.net/item/volgh-admin-dashboard-html-template/24716170">Buy Now</a>
                    <a class="btn btn-secondary" target="_blank" href="https://themeforest.net/user/spruko/portfolio">Our Portfolio</a>
            ...
            <div class="col-xxl-4 col-xl-5 col-lg-5 col-md-6 col-sm-8 col-12">
                ...
                <div class="card custom-card my-4">
                    <div class="card-body p-5">
                        <p class="mb-0 text-center login100-form-title">Login</p>
                        <form action="{{ url('/login') }}" method="post">
                            @csrf
                        <div class="row gy-3">
                            <div class="col-xl-12 wrap-input100">
                                <div class="position-relative">
                                    <input type="text" name="email" class="input100" id="signin-username" placeholder="user name">
                                    <span class="symbol-input100"> <i class="zmdi zmdi-email" aria-hidden="true"></i> </span>
                                </div>
                            </div>
                            <div class="col-xl-12 mb-2 wrap-input100">
                                <div class="position-relative">
                                    <input type="password" name="password" class="input100" id="signin-password" placeholder="password">
